...
- **scikit-learn Pipelines:** Весь процесс обработки данных (scaling, encoding, feature engineering) объединены в единый пайплайн. Это гарантирует отсутствие уточки данных и простоту деплоя.
